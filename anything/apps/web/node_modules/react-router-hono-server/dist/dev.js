...
function reactRouterHonoServer(options = {}) {
  ...
  return {
    ...
    async config(config, env) {
      ...
      const isEnvironmentApiEnabled = pluginConfig.future.unstable_viteEnvironmentApi ?? pluginConfig.future.v8_viteEnvironmentApi;
      const flagName = pluginConfig.future.unstable_viteEnvironmentApi ? "unstable_viteEnvironmentApi" : "v8_viteEnvironmentApi";
