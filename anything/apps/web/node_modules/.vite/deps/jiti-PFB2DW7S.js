  ...
  "node_modules/jiti/dist/jiti.cjs"(exports, module) {
    (() => {
      var e = { "./node_modules/.pnpm/mlly@1.8.2/node_modules/mlly/dist lazy recursive"(e2) {
        ...
        "use strict";
        e2.exports = require_node_fs();
      }, "node:module"(e2) {
        "use strict";
        e2.exports = require_node_module();
      }, "node:path"(e2) {
        "use strict";
      ...
      (() => {
        ...
        }, Qe = require_node_url(), Ze = require_node_assert(), Xe = require_node_process();
        var et = __webpack_require__("node:path");
        const tt = require_node_v8(), it = require_node_util(), st = new Set(Be.builtinModules);
...
Default "index" lookups for the main are deprecated for ES modules.`, "DeprecationWarning", "DEP0151");
        ...
        function _tryModuleResolve(e3, t3, i2) {
          try {
            ...
            if (!jt.has(e4 == null ? void 0 : e4.code)) throw e4;
          }
        }
        ...
        function normalizeAliases(e3) {
          ...
          for (const e4 in t3) for (const i2 in t3) i2 === e4 || e4.startsWith(i2) || ((_a2 = t3[e4]) == null ? void 0 : _a2.startsWith(i2)) && $t.has(t3[e4][i2.length]) && (t3[e4] = t3[i2] + t3[e4].slice(i2.length));
        ...
        const ei = (function() {
          ...
          return "/bin/jsh" === zt.SHELL && ((_a2 = Jt.versions) == null ? void 0 : _a2.webcontainer) ? { name: "stackblitz", ci: false } : { name: "", ci: false };
        })(), ti = (ei.name, Jt.platform || ""), ii = !!zt.CI || false !== ei.ci, si = !!((_b = Jt.stdout) == null ? void 0 : _b.isTTY), ri = (zt.DEBUG, "test" === Yt || !!zt.TEST), ni = ("production" === Yt || zt.MODE, "dev" === Yt || "development" === Yt || zt.MODE, zt.MINIMAL, /^win/i.test(ti)), ai = (/^linux/i.test(ti), /^darwin/i.test(ti), !zt.NO_COLOR && (!!zt.FORCE_COLOR || (si || ni) && zt.TERM), (((_c = Jt.versions) == null ? void 0 : _c.node) || "").replace(/^v/, "") || null), oi = (Number(ai == null ? void 0 : ai.split(".")[0]), !!((_d = Jt == null ? void 0 : Jt.versions) == null ? void 0 : _d.node)), ci = "Bun" in globalThis, hi = "Deno" in globalThis, li = "fastly" in globalThis, pi = [["Netlify" in globalThis, "netlify"], ["EdgeRuntime" in globalThis, "edge-light"], ["Cloudflare-Workers" === ((_e2 = globalThis.navigator) == null ? void 0 : _e2.userAgent), "workerd"], [li, "fastly"], [hi, "deno"], [ci, "bun"], [oi, "node"]];
        !(function() {
          let e3 = pi.find((e4) => e4[0]);
          if (e3) e3[1];
        })();
        const ui = require_node_tty(), di = ((_h = (_g = (_f = ui == null ? void 0 : ui.WriteStream) == null ? void 0 : _f.prototype) == null ? void 0 : _g.hasColors) == null ? void 0 : _h.call(_g)) ?? false, base_format = (e3, t3) => {
          if (!di) return (e4) => e4;
        ...
        function utils_hash(e3, t3 = 8) {
          return ((function() {
            ...
            try {
              return Ei = !!((_b2 = (_a2 = Ht()).getFips) == null ? void 0 : _b2.call(_a2)), Ei;
            } catch {
              return Ei = false, Ei;
            }
        ...
        function jitiInteropDefault(e3, t3) {
          return e3.opts.interopDefault ? (function(e4) {
            ...
            return new Proxy(e4, { get(t5, n3) {
              ...
              let c3;
              return "__esModule" === n3 ? c3 = true : "default" === n3 ? c3 = a2 ? e4 : "function" == typeof (i2 == null ? void 0 : i2.default) && e4.__esModule ? i2.default : i2 : n3 in t5 ? c3 = t5[n3] : y2 && (c3 = i2[n3], "function" == typeof c3 && (c3 = c3.bind(i2))), E2.set(n3, c3), c3;
        ...
        function jitiResolve(e3, t3, i2) {
          ...
          let c2 = (i2 == null ? void 0 : i2.parentURL) || e3.url;
          isDir(c2) && (c2 = pathe_M_eThtNZ_join(c2, "_index.js"));
          const l2 = ((i2 == null ? void 0 : i2.async) ? [i2 == null ? void 0 : i2.conditions, ["node", "import"], ["node", "require"]] : [i2 == null ? void 0 : i2.conditions, ["node", "require"], ["node", "import"]]).filter(Boolean);
          for (const i3 of l2) {
            try {
          ...
          for (const a3 of e3.additionalExts) {
            ...
            if ((ki.test(e3.filename) || ki.test(((_a2 = e3.parentModule) == null ? void 0 : _a2.filename) || "") || bi.test(t3)) && (n2 = tryNativeRequireResolve(e3, t3.replace(bi, ".$1t$2"), c2, i2), n2)) return n2;
          }
          if (!(i2 == null ? void 0 : i2.try)) throw a2;
        }
        function tryNativeRequireResolve(e3, t3, i2, n2) {
          try {
            return e3.nativeRequire.resolve(t3, { ...n2, paths: [pathe_M_eThtNZ_dirname(fileURLToPath(i2)), ...(n2 == null ? void 0 : n2.paths) || []] });
          } catch {
          }
        }
        const wi = require_promises(), Ci = require_node_perf_hooks(), Si = require_node_vm();
        ...
        function jitiRequire(e3, t3, i2) {
          ...
          if (n2[a2]) return jitiInteropDefault(e3, (_a2 = n2[a2]) == null ? void 0 : _a2.exports);
...
`;
        ...
        function transform(e3, t3) {
          let i2 = getCache(e3, t3, () => {
            var _a2;
            const i3 = e3.opts.transform({ ...e3.opts.transformOptions, babel: { ...e3.opts.sourceMaps ? { sourceFileName: t3.filename, sourceMaps: "inline" } : {}, ...(_a2 = e3.opts.transformOptions) == null ? void 0 : _a2.babel }, interopDefault: e3.opts.interopDefault, ...t3 });
        ...
        function eval_evalModule(t3, i2, n2 = {}) {
          var _a2;
          const a2 = n2.id || (n2.filename ? basename(n2.filename) : `_jitiEval.${n2.ext || (n2.async ? "mjs" : "js")}`), c2 = n2.filename || jitiResolve(t3, a2, { async: n2.async }), l2 = n2.ext || extname(c2), y2 = n2.cache || t3.parentCache || {}, E2 = /\.[cm]?tsx?$/.test(l2), w2 = ".mjs" === l2 || ".js" === l2 && "module" === ((_a2 = (function(e3) {
            for (; e3 && "." !== e3 && "/" !== e3; ) {
          ...
          })(c2)) == null ? void 0 : _a2.type), C2 = ".cjs" === l2, S2 = n2.forceTranspile ?? (!C2 && !(w2 && n2.async) && (E2 || w2 || t3.isTransformRe.test(c2) || hasESMSyntax(i2))), I2 = Ci.performance.now();
          if (S2) {
          ...
          const F2 = (function(e3, t4) {
            return `(${(t4 == null ? void 0 : t4.async) ? "async " : ""}function (exports, require, module, __filename, __dirname, jitiImport, jitiESMResolve) { ${e3}
});`;
          })(i2, { async: n2.async });
          try {
            ...
            "SyntaxError" === i3.name && n2.async && t3.nativeImport ? (debug(t3, "[esm]", "[import]", "[fallback]", c2), j2 = (function(t4, i4, n3, a3, c3) {
              ...
              return (...i5) => {
                ...
                const importViaTempFile = () => (c4 = (function(t5, i6) {
                  ...
                  if ("ENAMETOOLONG" !== (e3 == null ? void 0 : e3.code)) throw e3;
...
//# sourceMappingURL=jiti-PFB2DW7S.js.map
