            ...
            <div style={{ display: 'grid', gap: '12px', marginTop: '10px' }}>
              {cars.map((car: any) => (
                <div key={car.id} style={{ border: '1px solid #e2e8f0', padding: '12px', borderRadius: '8px', backgroundColor: '#f8fafc' }}>
                  <h5 style={{ margin: '0 0 5px 0' }}>{car.title || 'إعلان سيارة جديد'}</h5>
                  <p style={{ margin: '0', fontSize: '13px' }}>💰 السعر: <strong style={{color: '#2563eb'}}>{car.price} KWD</strong></p>
                  <p style={{ margin: '3px 0', fontSize: '12px', color: '#475569' }}>📋 {car.description || 'لا تتوفر تفاصيل إضافية'}</p>
                  ...
                  <div style={{ display: 'flex', gap: '6px', marginTop: '10px' }}>
                    {/* إخفاء زر موافقة تلقائياً إذا أصبحت حالة السيارة نشطة أو معتمدة لضمان تصفية نقرات التحكم */}
