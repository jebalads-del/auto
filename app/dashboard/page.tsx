...
<head>
    ...
    <link rel="preconnect" nonce="RxgfvnWcQTDY3AgFGTcb4g==" href="https://fonts.googleapis.com">
    <link rel="preconnect" nonce="RxgfvnWcQTDY3AgFGTcb4g==" href="https://fonts.gstatic.com" crossorigin>
    <link rel="stylesheet" nonce="RxgfvnWcQTDY3AgFGTcb4g==" href="https://fonts.googleapis.com/css2?family=Bungee&family=Montserrat:wght@100;300;400;500;600;700&display=swap">

            <link rel="stylesheet" nonce="RxgfvnWcQTDY3AgFGTcb4g==" href="/css/front.css?id=8a2a22d4fdd8f71cdf8183d3a6e5a956">
        <link rel="preload" nonce="RxgfvnWcQTDY3AgFGTcb4g==" href="/js/app.js?id=deea45f00d0ac0e2ea63ee6a3a417dff" as="script">
    ...
    <script nonce="RxgfvnWcQTDY3AgFGTcb4g==" type="text/javascript">
        window.Spark = {"collectsBillingAddress":false,"collectsEuropeanVat":false,"env":"production","roles":["admin","member","viewer"],"state":null,"stripeKey":"pk_live_51H4yVKFoQollccOglSdqQ9hK0Ux7GcxtldtbJleZP9qMPYdJ3p76bqxEf7rWwXwxgTi1qiYgBOYCNhiNgZvIljCo00pCY5HoQC","cashierPath":"stripe","teamsPrefix":"team","teamsIdentifiedByPath":true,"trialDays":0,"teamTrialDays":0,"defaultRole":"viewer","operationsCosts":null};
            ...
            <script nonce="RxgfvnWcQTDY3AgFGTcb4g==" data-cfasync="false" data-owner="freestar" type="text/javascript">
            ...
            <script nonce="RxgfvnWcQTDY3AgFGTcb4g==" async data-cfasync="false" data-owner="freestar" src="https://a.pub.network/tinyurl-com/pubfig.min.js"></script>
        </template>
    </head>
...
<body>
    ...
    <div id="tinyurl"></div>
            ...
            <script nonce="RxgfvnWcQTDY3AgFGTcb4g==" type="text/javascript" src="/js/manifest.js?id=cffd356c2e850e9729ab2a0f0be60ae6" defer></script>
        <script nonce="RxgfvnWcQTDY3AgFGTcb4g==" type="text/javascript" src="/js/vendor.js?id=6d38f334e303176f2b10f58b897d92a2" defer></script>
        <script nonce="RxgfvnWcQTDY3AgFGTcb4g==" type="text/javascript" src="/js/app.js?id=deea45f00d0ac0e2ea63ee6a3a417dff" defer></script>
