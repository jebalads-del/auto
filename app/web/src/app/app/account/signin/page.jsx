...
function MainComponent() {
  ...
  // قراءة رسالة الخطأ من URL — عند فشل الدخول يعيد النظام التوجيه مع ?error=...
  useEffect(() => {
    if (typeof window !== "undefined") {
      const params = new URLSearchParams(window.location.search);
      ...
      if (errorCode) {
        const errorMessages = {
          OAuthSignin: "تعذر بدء تسجيل الدخول. الرجاء المحاولة مرة أخرى.",
          OAuthCallback: "فشل تسجيل الدخول بعد إعادة التوجيه.",
          OAuthCreateAccount: "تعذر إنشاء حساب بهذه الطريقة.",
          EmailCreateAccount: "لا يمكن استخدام هذا البريد الإلكتروني.",
          Callback: "حدث خطأ أثناء تسجيل الدخول.",
          OAuthAccountNotLinked:
            "هذا الحساب مرتبط بطريقة دخول مختلفة. جرب استخدامها.",
          CredentialsSignin: "البريد الإلكتروني أو كلمة المرور غير صحيحة.",
          "no-account": "لا يوجد حساب بهذا البريد. هل تريد التسجيل أولاً؟",
          AccessDenied: "ليس لديك صلاحية تسجيل الدخول.",
          Configuration: "تسجيل الدخول لا يعمل الآن. الرجاء المحاولة لاحقاً.",
          Verification: "انتهت صلاحية الرابط. اطلب رابطاً جديداً.",
        };
        setError(
          errorMessages[errorCode] || `فشل تسجيل الدخول — الرمز: ${errorCode}`,
        );
      }
    }
  }, []);
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessages = {
        OAuthSignin: "تعذر بدء تسجيل الدخول. الرجاء المحاولة مرة أخرى.",
        OAuthCallback:
          "فشل تسجيل الدخول بعد إعادة التوجيه. الرجاء المحاولة مرة أخرى.",
        OAuthCreateAccount: "تعذر إنشاء حساب بهذه الطريقة. جرب طريقة أخرى.",
        EmailCreateAccount: "لا يمكن استخدام هذا البريد الإلكتروني.",
        Callback: "حدث خطأ أثناء تسجيل الدخول. الرجاء المحاولة مرة أخرى.",
        OAuthAccountNotLinked:
          "هذا الحساب مرتبط بطريقة دخول مختلفة. جرب استخدامها.",
        CredentialsSignin: "البريد الإلكتروني أو كلمة المرور غير صحيحة.",
        AccessDenied: "ليس لديك صلاحية تسجيل الدخول.",
