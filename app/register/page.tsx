...
export default function RegisterPage() {
  ...
  // الأنماط المشتركة المطابقة لتصميم واجهتك الحالي
    ...
    <div style={containerStyle}>
      ...
      <form onSubmit={handleRegister}>
        ...
        <div style={{ marginTop: '25px', fontSize: '15px', color: '#666666' }}>
          لديك حساب بالفعل؟ <Link href="/login" style={{ color: '#2563eb', textDecoration: 'none', marginRight: '5px' }}>تسجيل الدخول</Link>
        </div>
      </form>
    </div>
  );
