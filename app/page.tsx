...
const styles = {
  ...
  viewLink: { display: 'block', textAlign: 'center' as const Ram: 'center', backgroundColor: '#2563eb', color: 'white', padding: '10px', borderRadius: '8px', textDecoration: 'none', fontSize: '13px', fontWeight: 'bold', marginTop: 'auto' },
